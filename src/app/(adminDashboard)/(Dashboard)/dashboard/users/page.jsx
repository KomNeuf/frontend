...
export default function Contact() {
  ...
  const {
    ...
    isLoading,
    error,
  } = api.adminApis.useGetAdminAllUsersQuery("");
  ...
  const filterData = (allUsers, searchQuery) => {
    ...
    <main className="p-3 md:p-3 lg:p-4 xl:p-6">
            ...
            <label htmlFor="name" className="lg:w-[60%] relative max-h-max">
              <span className="relative">
                ...
                <input
                  ...
                  className="text-neutral-500 w-full text-md leading-5 placeholder:text-sm  placeholder:text-neutral-400 whitespace-nowrap border border-stone-300 focus:outline focus:outline-2 outline-offset-1 outline-slate-400/90 justify-center mt-1 px-12 py-3 rounded-md items-start"
                />
              </span>
            </label>
          </div>
      ...
      <section className="mt-5">
        <div className="table_container overflow-auto max-w-[1030px] relative max-h-[calc(100vh-210px)]">
          <TableContainer component={Paper}>
            <Table className="w-full" cellPadding={14}>
              ...
              {isFetching ? (
                ...
                <TableBody>
                  {filterData(allUsers, searchData.name)
                    ...
                    .map((each, index) => (
                      ...
                      >
                        ...
                        <TableCell className="gap-1.5 lg:gap-2 xl:gap-2.5 single-line-text">
                          <Link
                            href={`/dashboard/users/${each._id}?action=view`}
                          ...
                          <Link
                            href={`/dashboard/users/${each._id}?action=update`}
                            className="!inline mx-1"
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
          ...
          {!(isLoading || isFetching) && allUsers?.length === 0 && (
